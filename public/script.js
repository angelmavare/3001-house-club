...
async function loadAchievementsDirectly() {
    try {
        ...
        // Hide the databases list and show achievements directly
        databasesList.style.display = 'none';
        databaseDetail.classList.remove('hidden');
        ...
        databasesContainer.innerHTML = `<p class="error">Error al cargar los logros: ${error.message}</p>`;
    } finally {
        loading.style.display = 'none';
    }
}
...
async function loadMembersDirectly() {
    try {
        ...
        // Hide the databases list and show members directly
        databasesList.style.display = 'none';
        databaseDetail.classList.remove('hidden');
        ...
        databasesContainer.innerHTML = `<p class="error">Error al cargar los miembros: ${error.message}</p>`;
    } finally {
        loading.style.display = 'none';
    }
}
